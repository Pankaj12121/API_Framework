...
public class SensiBullSellOrder extends WebPage {
	...
	public String generateParentJson(XSSFWorkbook workbook, String sheetName, String scenarioID,
		...
		try {
			...
			LinkedHashMap<Object, Object> jsonMap = excelOperation.getScenarioDataObject(workbook, "DT_SellOrder", scenarioID)
					.get(0);
	...
	public void sensibullSellOrderStep(XSSFWorkbook workbook, String sheetName, ExcelOperation excelOperation,
