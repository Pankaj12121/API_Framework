...
public class SensiBullOrderBook extends WebPage {
	...
	public void sensibullOrderBookStep(XSSFWorkbook workbook, String sheetName, ExcelOperation excelOperation,
			String scenarioID) throws Exception {
		try {
			String uri = ServiceEndpoint.sensibullOrderBook.getUrl();
			...
			long start = 0L;
			long end = 0L;
			String nJson = "{\"strategyCode\": \"\",\"nestOrdNum\":\"201027000000112\"}";
			...
			String flag = NewJson.get("success").getAsString();
