...
public class GenerateJWTAPI extends WebPage {
	...
	public void extServicesGenerateJWTAPIStep(XSSFWorkbook workbook, String sheetName, ExcelOperation excelOperation,
			String scenarioID) throws Exception {
		try {
			String uri = ServiceEndpoint.generateJWTAPI.getUrl();
			...
			String nJson = "{" + "\"clientID\"" + ":" + "\"B159142\"" + "," + "\"sessionID\"" + ":"
					+ TestEngine.JWTsessionID + "}";
			...
			String authToken = NewJson2.get("authToken").getAsString();
