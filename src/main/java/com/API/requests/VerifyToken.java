...
public class VerifyToken extends WebPage {
	...
	public void extServicesVerifyTokenStep(XSSFWorkbook workbook, String sheetName, ExcelOperation excelOperation,
			String scenarioID) throws Exception {
		try {
			String uri = ServiceEndpoint.verifyToken.getUrl();
			...
			String msg = NewJson.get("message").getAsString();
