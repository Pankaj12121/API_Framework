...
public class SensiBullPositions extends WebPage {
	...
	public void sensiBullPositionsStep(XSSFWorkbook workbook, String sheetName, ExcelOperation excelOperation,
			String scenarioID) throws Exception {
		try {
			String uri = ServiceEndpoint.sensibullPositions.getUrl();
